...
const SingleCourse = () => {
    ...
    useEffect(()=>{
      ...
      const onchangeHandler=(id)=>{
        ...
        const data={"_id":id} 
        axios.post("http://10.0.33.138:3001/api/view",data)
        .then((response)=>{
    ...
    <div><br/>
      ...
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        ...
        <TableBody>
          ...
          {selectedCourse.map((value,index) =>{ 
            ...
            >
              <StyledTableCell component="th" scope="row" onClick={()=>onchangeHandler(course._id)}> {value.cName}</StyledTableCell>
              ...
              <StyledTableCell align="right"><Button onClick={()=>updateCourse} variant=''>Update </Button></StyledTableCell> */}
            </StyledTableRow>
            )
          }
)
